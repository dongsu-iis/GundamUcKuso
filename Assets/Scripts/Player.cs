...
public class Player : MonoBehaviour
{
    ...
    public float m_magnetDistance; // アイテムを引きつける距離
    ...
    public float m_magnetDistanceTo; // アイテムを引きつける距離（レベルが最大値の時）
    ...
    private void Awake()
    {
        ...
        m_magnetDistance = m_magnetDistanceFrom; // アイテムを引きつける距離
    }
    ...
    public void AddExp(int exp)
    {
        ...
        m_magnetDistance = Mathf.Lerp(
            m_magnetDistanceFrom, m_magnetDistanceTo, t); // アイテムを引きつける距離
    }
